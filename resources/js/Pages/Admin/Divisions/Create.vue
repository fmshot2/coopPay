...
const submit = () => {
    form.post(route('admin.divisions.store'), {
        ...
        onError: () => {
            toast.error('Failed to create division. Please check the form.')
        }
    })
}
</script>
    ...
    <AppLayout>
        <div class="space-y-6 max-w-xl m-auto">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-foreground">Add Division</h2>
                    <p class="text-sm text-muted-foreground mt-1">
                        Create a new cooperative division
                    </p>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Divisions help organize members into groups.
                    </CardDescription>
                </CardHeader>
                <CardContent>
