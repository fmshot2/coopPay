    ...
    <AppLayout>
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-foreground">Inbox</h2>
                    <p class="text-sm text-muted-foreground mt-1">
                        Manage messages from cooperative members
                    </p>
                </div>
                <div class="flex items-center gap-3">
                    ...
                    <Button @click="router.visit(route('admin.messages.create'))">
                        ...
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <div class="flex items-center gap-1">
                                <Button variant="ghost" size="icon"
                                    @click="router.visit(route('admin.messages.show', message.id))">
                                    <Eye class="h-4 w-4" />
                                </Button>
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <select
                            ...
                            class="border border-input rounded-md px-2 py-1 text-sm bg-background"
                        >
