...
const submitImport = () => {
    importForm.post(route('admin.loans.import.csv'), {
        onSuccess: () => {
            importForm.reset()
        },
    })
        ...
        <div class="space-y-6">
            <div>
                ...
                <p class="text-sm text-muted-foreground mt-1">
                    Upload a CSV file with no header row.
                    This are the columns required:
                    S/NO, NAME OF BENEFICIARY, ACCOUNT NUMBER, BANK, AMOUNT (#) DATE.
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Use a plain CSV file without headers.
                        <!-- If you want a sample, download the template. -->
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submitImport" class="space-y-4">
                        ...
                        <div
                            ...
                            <p>
                                Column 1: <span class="font-medium">s/n</span><br />
                                Column 2: <span class="font-medium">Name</span><br />
                                Column 3: <span class="font-medium">Account Number</span><br />
                                Column 4: <span class="font-medium">Bank</span><br />
                                Column 5: <span class="font-medium">Amount</span><br />
                                Column 6: <span class="font-medium">Date</span><br />
                            </p>
                        </div>
