        ...
        <div class="w-full max-w-md space-y-6 relative z-10">
            ...
            <div class="text-center space-y-2">
                ...
                <p class="text-sm" style="color: oklch(0.75 0.08 150)">
                    Cooperative Payment Management System
                </p>
            </div>
                ...
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div class="flex items-center gap-2">
                            <input id="remember" v-model="form.remember" type="checkbox" class="rounded border-input" />
                            <Label for="remember" class="font-normal cursor-pointer">
                                Remember me
                            </Label>
                        </div>
