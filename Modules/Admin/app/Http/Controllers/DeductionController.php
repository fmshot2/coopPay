    ...
    public function approve(MonthlyDeduction $deduction)
    {
        try {
            if ($deduction->status !== 'pending') {
                return $this->respondSingleError('This deduction has already been processed.');
            }
            ...
            return $this->respondSuccess('Deduction approved and loan plan updated.');
        } catch (\Throwable $e) {
            return $this->respondException($e, 'Failed to approve deduction.');
        }
    }
