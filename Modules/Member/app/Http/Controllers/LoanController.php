...
class LoanController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Member/Loans/Create', [
            'loanTypes' => $loanTypes,
    ...
    public function show(LoanPlan $loan)
    {
        $loan->load('loanType');

        return Inertia::render('Member/Loans/Show', [
            'loan' => $loan,
        ]);
    }
    ...
    public function history()
    {
        ...
        return Inertia::render('Member/Loans/History', [
            'loans' => $loans,
        ]);
    }
